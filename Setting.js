...
global.owner = process.env.OWNER_NUMBER || '221760263631' ; // Add Your Number without +
...
module.exports = {
  ...
  ownername:  process.env.OWNER_NAME || `bicomaru Shogunaī`, // add your name
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'sk-proj-tRVHYrvKyGfFsZCDsfXlT3BlbkFJyWVFHrbQCeUWCefRGm6x' , // add your openai key if you have it
